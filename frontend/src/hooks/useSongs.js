...
export const useSongs = () => {
  return useQuery({
    queryKey: ['songs'], // I need the song identified by this key and also cached if needed
    queryFn: musicApi.getSongs,   // The function that fetches the data// src/hooks/useSongs.js
